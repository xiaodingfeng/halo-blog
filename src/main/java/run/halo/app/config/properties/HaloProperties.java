...
public class HaloProperties {
     ...
     * Work directory.
     */
    private String workDir = ensureSuffix(USER_HOME, FILE_SEPARATOR) + ".cyz_halo" + FILE_SEPARATOR;

    /**
     * Halo backup directory.(Not recommended to modify this config);
     */
    private String backupDir = ensureSuffix(TEMP_DIR, FILE_SEPARATOR) + "cyz_halo-backup" + FILE_SEPARATOR;

    /**
     * Halo backup markdown directory.(Not recommended to modify this config);
     */
    private String backupMarkdownDir = ensureSuffix(TEMP_DIR, FILE_SEPARATOR) + "cyz_halo-backup-markdown" + FILE_SEPARATOR;

    /**
     * Halo data export directory.
     */
    private String dataExportDir = ensureSuffix(TEMP_DIR, FILE_SEPARATOR) + "cyz_halo-data-export" + FILE_SEPARATOR;
