...
public class InstallController {
    ...
    private void createDefaultComment(@Nullable PostDetailVO post) {
        ...
        comment.setAuthor("THEA的小迷弟");
        comment.setAuthorUrl("http://blog.ducker.xyz");
        comment.setContent("欢迎使用 THEA，这是你的第一条评论，头像来自 [Gravatar](https://cn.gravatar.com)，你也可以通过注册 [Gravatar](https://cn.gravatar.com) 来显示自己的头像。\n小白不爱在此");
        comment.setEmail("mrxiaodfeng@163.com");
    ...
    private PostDetailVO createDefaultPostIfAbsent(@Nullable Category category) {
        ...
        postParam.setSlug("hello_thea");
        postParam.setTitle("Hello THEA");
        postParam.setStatus(PostStatus.PUBLISHED);
        postParam.setOriginalContent("## Hello THEA\n" +
                "\n" +
                "如果你看到了这一篇文章，那么证明你已经安装成功了，\n\n\n小迷弟来了嘻嘻嘻嘻嘻" +
                "\n");
    ...
    private Category createDefaultCategoryIfAbsent() {
        ...
        category.setDescription("这是你的默认分类，如不需要，删除即可。嘻嘻嘻");
